...
public class VentanaProfesores extends JFrame{
	...
	DefaultListModel<String> profesores;
	//Ventana
	public VentanaProfesores(DefaultListModel<String> profesores) throws ClassNotFoundException, IOException {
	...
	private void init(){
		//Titulo
		JLabel lblNewLabel = new JLabel("Profesores");
		...
		ImageIcon base = new ImageIcon("src/main/resources/docente.png");
